...
import { Home, Phone, Mail, Info, ChevronRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[var(--bg-main)] px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gray-50 py-8 border-b border-gray-100">
                <div className="container mx-auto">
                    <h1 className="text-[28px] sm:text-[32px] font-bold text-[#1e5066] mb-3">Contact Us</h1>
                    <div className="flex items-center gap-2 text-[14px] text-gray-500 font-medium">
                        ...
                        <span className="text-[var(--primary)] font-bold">Contact Us</span>
                    </div>
                </div>
            </div>
