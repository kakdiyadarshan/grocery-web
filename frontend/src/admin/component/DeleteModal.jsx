        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm animate-in fade-in duration-300" onClick={onClose}>
            ...
            >
                ...
                <div className="px-8 pb-8 flex flex-col items-center text-center">
                    ...
                    <h3 className="text-lg font-black font-lighter text-black mb-2">
                    ...
                    <div className="flex w-full gap-3">
                        <button
                            onClick={onClose}
                            className="flex-1 px-6 py-3 border border-gray-300 text-gray-600 font-bold rounded-[4px] text-xs  tracking-widest hover:bg-gray-50 transition-all active:scale-95"
                        >
                            Cancel
                        </button>
                        <button
                            onClick={onConfirm}
                            disabled={isLoading}
                            className="flex-1 px-6 py-3 bg-red-500 text-white font-bold rounded-[4px] text-xs tracking-widest shadow-lg shadow-red-200 hover:bg-red-600 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                        >
                            {isLoading ? (
