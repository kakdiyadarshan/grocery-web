    ...
    const columns = useMemo(() => [
            ...
            render: (item) => (
                <div className="text-xs">
                    <div className="font-medium">
                        {new Date(item.offer_start_date).toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' })}
                    </div>
                    <div className="text-gray-400">
                        {new Date(item.offer_end_date).toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' })}
                    </div>
                </div>
        ...
        },
        {
            ...
            render: (item) => {
                ...
                return (
                    <span className={`px-2 py-1 text-xs font-bold rounded border ${isExpired
                ...
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-[4px] shadow-2xl w-full max-w-[650px] overflow-hidden transform transition-all">
                        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-white">
                            ...
                            <button onClick={closeModal} className="text-gray-400 hover:text-red-500 transition-colors bg-gray-50 hover:bg-red-50 p-2 rounded-[4px]">
                                <FiX size={20} />
                            </button>
                        </div>
