    ...
    return (
        <footer className="bg-white border-t border-gray-100 pt-16 pb-8 relative mt-12">
            <div className="container mx-auto px-4 lg:px-6">
                ...
                <button 
                    onClick={scrollToTop}
                    className="absolute -top-5 right-6 sm:right-10 w-10 h-10 bg-[var(--primary)] text-white rounded-full flex items-center justify-center hover:bg-[var(--primary-hover)] transition-colors shadow-md z-10"
