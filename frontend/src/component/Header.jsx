...
const Header = () => {
  ...
  return (
      ...
      <div className="border-b border-gray-100 py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            {/* Wishlist Icon */}
            <button className="relative text-[var(--text-gray)] hover:text-[var(--primary)] transition-colors flex items-center gap-2">
    ...
    {/* Sub Header Navigation */}
      ...
      <div
        className={`fixed top-0 left-0 h-full w-[80vw] sm:w-[320px] bg-white z-[90] transform transition-transform duration-300 ease-in-out flex flex-col shadow-2xl lg:hidden ${
